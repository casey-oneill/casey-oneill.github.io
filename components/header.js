				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto">
							...
							<li class=nav-item>
								<a href="https://github.com/casey-oneill/" target="_blank" class="nav-link"><h4 class="my-0"><i class="fab fa-github-square"></i></h4></a>
							</li>
							<li class=nav-item>
								<a href="https://www.linkedin.com/in/caseyoneill/" target="_blank" class="nav-link"><h4 class="my-0"><i class="fab fa-linkedin"></i></h4></a>
							</li>
						</ul>
					</div>
				</div>
